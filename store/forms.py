...
class OrderForm(forms.ModelForm):
    ...
    project_code = forms.ModelChoiceField(queryset=UserProfile.objects.filter(hhmi_project_id__icontains='JVS'), to_field_name='hhmi_project_code', widget=forms.Select(attrs={'class': 'chosen-select'}))
    class Meta:
        model = Order
