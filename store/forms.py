...
class OrderLineInlineFormSet(
    inlineformset_factory(Order, OrderLine,
        ...
        widgets={
        'qty': NumInput(attrs={'min': '0', 'step': 'any', 'class': 'form-control text-center line_calc line_qty'}),
        'line_cost': NumInput(attrs={'step': 'any', 'class': 'form-control text-center line_calc line_cost', 'readonly': '1'}),
