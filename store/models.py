...
class Order(models.Model):
    ...
    submitter = models.OneToOneField(User, related_name='submitter', null=True)   #submitting order
    requester = models.OneToOneField(User, related_name='requester', null=True)  #only use when billing other person
    department = models.ForeignKey(Department, blank=True, null=True)
