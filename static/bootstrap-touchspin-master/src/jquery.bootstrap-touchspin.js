  ...
  $.fn.TouchSpin = function(options) {
    ...
    return this.each(function() {
      ...
      function _advanceInputGroup(parentelement) {
        ...
        // }
        // else {
          downhtml = '<span class="input-group-btn-prepend bootstrap-touchspin-injected"><button class="' + settings.buttondown_class + ' bootstrap-touchspin-down" type="button">' + settings.buttondown_txt + '</button></span>';
        ...
        // }
        //else {
          uphtml = '<span class="input-group-btn-append bootstrap-touchspin-injected"><button class="' + settings.buttonup_class + ' bootstrap-touchspin-up" type="button">' + settings.buttonup_txt + '</button></span>';
      ...
      function _buildInputGroup() {
        ...
        if (settings.verticalbuttons) {
          ...
          html = '<div class="input-group bootstrap-touchspin bootstrap-touchspin-injected input-group-lg"><span class="input-group-btn input-group-prepend"><button class="' + settings.buttondown_class + ' bootstrap-touchspin-down spin" type="button">' + settings.buttondown_txt + '</button></span><span class="input-group-addon bootstrap-touchspin-prefix input-group-prepend"><span class="input-group-text">' + settings.prefix + '</span></span><span class="input-group-addon bootstrap-touchspin-postfix input-group-append"><span class="input-group-text">' + settings.postfix + '</span></span><span class="input-group-btn input-group-append"><button class="' + settings.buttonup_class + ' bootstrap-touchspin-up spin" type="button">' + settings.buttonup_txt + '</button></span></div>';
        }
